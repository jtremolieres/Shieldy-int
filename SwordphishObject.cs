...
namespace NotifySecurity
{
    static class SwordphishObject
    {
        ...
        public static string NoHeaderFound = Resources.NoHeaderFound;
        public static string AnswerFromSwordphish = Resources.AnswerFromSwordphish;
        public static string NoAnswerFromSwordphish = Resources.NoAnswerFromSwordphish;

        public static string MsgIfSwordphishDetected= "\n\n" + Resources.MsgIfSwordphishDetected;
